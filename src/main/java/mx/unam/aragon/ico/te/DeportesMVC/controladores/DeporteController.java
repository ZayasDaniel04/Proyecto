...
public class DeporteController {
    ...
    public String equipo(Model model) {
        Equipo equipo = new Equipo(1,"Club Deportivo Guadalajara","Rebaño Sagrado","Akron",12,"https://i.pinimg.com/1200x/51/69/20/5169201c1d7c1aa468eaa4ba79cc72a3.jpg");
    ...
    public String nuevo(Model model) {
        model.addAttribute("equipo", new Equipo(0,"Club America","Aguilas","Azteca",15,"https://i.etsystatic.com/32229139/r/il/b5d5ff/4004851799/il_fullxfull.4004851799_f3zq.jpg"));
        return "formEquipo";
    }
    ...
    public String mostrarFormularioActualizar(@PathVariable Integer id, Model model) {
        ...
        model.addAttribute("equipo", equipo);
        return "actualizarEquipo";  // Nuevo template
    }
    ...
    public String procesarActualizacion(
        ...
        return "redirect:/tienda/actualizar/" + equipo.getId();  // Regresa al mismo formulario
    }
}
